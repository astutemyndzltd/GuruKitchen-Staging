  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Restaurants Earning</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() . '/drivers' !!}"><i class="fa fa-list mr-2"></i>Drivers Earning</a>
        </li>
        @can('earnings.create')
        <li class="nav-item">
